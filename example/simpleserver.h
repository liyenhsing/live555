...
class simpleserver: public RTSPServer {
public:
  static simpleserver* createNew(UsageEnvironment& env, Port ourPort,
  ...
  class TestRTSPClientConnection : public RTSPClientConnection
	...
	public:
		...
		TestRTSPClientConnection(simpleserver* ourServer, int clientSocket, struct sockaddr_in clientAddr);
		virtual ~TestRTSPClientConnection();
	protected:
		virtual void handleCmd_DESCRIBE(char const* urlPreSuffix, char const* urlSuffix, char const* fullRequestStr);

	private:
		simpleserver&	m_ourServer;
...
protected:
  simpleserver(UsageEnvironment& env, int ourSocket, Port ourPort,
